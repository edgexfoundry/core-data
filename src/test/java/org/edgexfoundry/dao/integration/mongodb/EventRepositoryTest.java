...
public class EventRepositoryTest {
	...
	/**
	 * Create and save an instance of the Event before each test Note: the
	...
	public void testUpdate() {
		...
		assertEquals("device id was not updated appropriately in event update", "newdeviceid", event2.getDevice());
		assertNotEquals("after modification, modified timestamp still the same as the event's create timestamp",
